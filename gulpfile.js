...
const sourceFiles = ['./practicash/codigosClase/tarjetaCredito.hs']; // Agrega aquí todos los archivos Haskell que quieras observar
const outputDirectory = './practicash/codigosClase/';
const executableName = 'tarjetaCredito';
